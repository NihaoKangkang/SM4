...
def sm4_str_encode(text, key):
    ...
    MK= [int(keyHexString[:8], 16), int(keyHexString[8:16], 16), int(keyHexString[16:24], 16), int(keyHexString[24:], 16)]
    K = []
    K.append(MK[0] ^ FK[0])
    K.append(MK[1] ^ FK[1])
    K.append(MK[2] ^ FK[2])
